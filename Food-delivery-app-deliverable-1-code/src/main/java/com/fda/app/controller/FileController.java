...
public class FileController {
	...
	@DeleteMapping("/file/delete/{type}/{file}")
	public ApiResponseDto deleteFile(@PathVariable("type") String type, @PathVariable("file") String file) {
		ApiResponseDtoBuilder apiResponseDtoBuilder = new ApiResponseDtoBuilder();
		fileService.deleteFile(type, file, apiResponseDtoBuilder);
		return apiResponseDtoBuilder.build();
	}
}
