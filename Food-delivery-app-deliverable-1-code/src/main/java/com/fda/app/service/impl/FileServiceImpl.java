...
import com.fda.app.exception.FileStorageException;
import com.fda.app.exception.MyFileNotFoundException;
import com.fda.app.property.FileStorageProperties;
import com.fda.app.service.IFileService;
...
public class FileServiceImpl implements IFileService {
	...
	public void deleteFile(String type, String fileName, ApiResponseDtoBuilder apiResponseDtoBuilder) {
		File file = new File(
				environment.getProperty("file.upload-dir") + File.separator + type + File.separator + fileName);
		if (file.exists()) {
			file.delete();
